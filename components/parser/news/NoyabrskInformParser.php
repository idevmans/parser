...
class NoyabrskInformParser extends AbstractBaseParser
{
    ...
    {
        return 'https://noyabrsk-inform.ru';
    }
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="entry-content clearfix"]');
