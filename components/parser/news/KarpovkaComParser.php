...
class KarpovkaComParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $this->removeDomNodes($contentCrawler, '//p[contains(@class,"desc_rh")]/span[contains(@class,"right")]');
        $this->removeDomNodes($contentCrawler, '//strong[contains(text(),"Обсудить эту и другие городские новости вы можете в группах интернет-газеты «Карповка")]/parent::p');
