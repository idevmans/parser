...
class ApiUralParser extends AbstractBaseParser
{
    ...
    protected function parseNewsPage(PreviewNewsDTO $previewNewsDTO): NewsPost
    {
        ...
        $newsPostCrawler = $newsPageCrawler->filterXPath('//div[@class="newsOne"]');
        ...
        $contentCrawler = $newsPostCrawler->filterXPath('//div[@class="in"]');

        $this->removeDomNodes($contentCrawler, '//div');
        $this->removeDomNodes($contentCrawler, '//*//text()[contains(., "© Служба новостей «АПИ»")]');
